...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Placeholder.noedit'
        db.add_column('cms_placeholder', 'noedit', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Placeholder.noedit'
        db.delete_column('cms_placeholder', 'noedit')
    ...
    models = {
        ...
        'cms.placeholder': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'noedit': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
